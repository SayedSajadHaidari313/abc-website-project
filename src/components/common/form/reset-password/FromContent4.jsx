...
const FromContent4 = () => {
  ...
  const { mutate: resendOtp, isLoading: isResending } =
    usePostForgotPasswordCreate();
      ...
      <form method="post" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <button
            ...
            className={`theme-btn btn-style-two d-flex align-items-center justify-content-center gap-2 ${
              timer > 0 ? "disabled" : ""
            }`}
