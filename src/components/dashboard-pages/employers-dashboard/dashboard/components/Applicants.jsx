...
import { useGetEmployerApplyJobData, useSingleDelete, useUpdateApplyJob } from "@/queries/apply.job.query";
import ViewApplicationModal from "../../all-applicants/components/ViewApplicationModal";
