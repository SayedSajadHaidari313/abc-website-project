...
export const RfpsPostCreate = (params) => {
  return postRequest(`rfp-user-store`, params);
};
...
export const updateRfps = async (params) => {
  return postRequest(`rfp-user/${params.get("id")}`, params, {
    headers: {
...
export const singleDelete = async (id) => {
  return deleteRequest(`rfp-user/${id}`, {
    params: {
      id,
    },
  });
...
export const getMyRfpsData = async (
  current,
  pageSize,
  searchQuery,
  category
